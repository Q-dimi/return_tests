module.exports = { 
    ...
    * @param {in_comment_outside_function_single} denoting if i am in a single line comment
    * @param {in_comment_type_outside_function_multi} tracking functions that are multiline... could use a count here and not an array
    ...
    * @param {bt_index_drop_off_function_name} the index that backtracks the arrow function name. '=' and ':'
    ...
    * @param {opening_bt_parentheses} opening parentheses used for ending
    * @param {closing_bt_parentheses} closing parentheses used for ending
    */
...
//way da jawn at, way da jawn at, way da dawn at, left right left right left right in da car on the way to carolines baby. shaws market for life bitch. hey k yeah im coming for you. watch the fk out.