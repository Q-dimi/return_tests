  ...
  /* 
   ...
   stack size keeps exceeding, run some logs. may need to re organize in-string
 ...
 */
 ...
 /*
  if not in a comment or string, keeping count of brackets so I know when to end the function... razzaaa brilliant? https://www.youtube.com/watch?v=FEolobdlSTk
 */
 ...
 */
 ...
 if(
  ...
  console.log('pushing the funciton finally ------------------------- not really though... finally got it to work but need to check bracket count...')
  push_function();
 } 
