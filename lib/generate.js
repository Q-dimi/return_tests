...
var in_comment_outside_function = false; //when in comment make sure to continue to traverse at the top... just add it in with the in string thing
var in_comment_type_outside_function = ''; //newLine or multi
...
var line_number = 0;
var in_comment_inside_function = false; //when in a comment and in a function, do not build the function string...
var in_comment_type_inside_function = ''; //newLine or multi
 ...
 for(let i = 0; i < folders.length; i++) {
  ...
  fs.recurseSync(folders[i].folder, folders[i].files == 'all' ? null : folders[i].files, (filepath, relative, filename) => {
   ...
   if(filename) { 
    ...
    in_function = false;
    in_comment_outside_function = false; //when in comment make sure to continue to traverse at the top... just add it in with the in string thing
    in_comment_type_outside_function = ''; //newLine or multi
    ...
    has_bracket = false;
    line_number = 0;
    in_comment_inside_function = false; //when in a comment and in a function, do not build the function string...
    in_comment_type_inside_function = ''; //newLine or multi
...
function iterate_through_file_text(data_index) {
 ...
 //check if in a comment here and use that to determine whether to push a bracket... this is for comments inside functions which are functions . ex: //function(){} --- avoids this
