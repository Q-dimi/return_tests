var fs = require('file-system');
  ...
  /* add the comments, run it, fix it, end it. done. rearrange some things near the top.. check for in function out of function in a better way if possible. then end it.
 ...
 */
 ...
 /* 
  enter into a string outside the function (if not or in a string, single-line comment, and multi-line comment)
 */
 ...
 */
 ...
 /* 
  if in a string, multiline comment, or single line comment outside of the function, recurse up and dont build a function
 */
 ...
 /*
  Enter into a regular function and start the build string. Above makes sure that the function below is built outside of a string, multiline comment and single line comment. So, I am getting the pure function when coming from the outside. When I do get a function, I ignore the outside, and focus on the inside. On the inside, I push every character, but dont run some conditions dependent on comments/strings. For example, I do not execute the function if in a string or comment and I do not push a bracket if in a string or comment. "Make America Great Again" through our will which comes from our soverign magesty. The communities were built upright, and the will was detered because of the rules and lack of connection. Now with connection, the will proceeds because there is less rule and more trust. In God we Trust. Definitely not red my friend if that makes sense. Hillary 2024.
 */
