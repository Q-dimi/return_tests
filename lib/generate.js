  ...
  /* 
   ...
   fix the arrow function and consider no equals sign at all.. unless i already did that... async () => {} -- just look into arrow more when you do this... so if no equals sign and a character is found after async or a character is found when async doesnt exist, end it
   ...
   maybe just take enclosed ( and = and type into consideration for regular... and ignore urnary operators.... im not sure if i can backtrack on those... ill add those in seperately once i look into how they can be formatted
  */
...
function is_async(bt_index_drop_off_function_name) { 
 ...
 if(
  ...
  bt_index_drop_off_function_name = bt_index_drop_off_function_name - 6; //if : then the function ended... add an if here
 }
