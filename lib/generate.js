 ...
 */
 ...
 /*
  I push an opening or closing bracket if i am not in a string, or comment. bracket lengths denote when the function ends... 
 */
...
function back_track_parameters(bt_index) { 
 ...
 //return the parameters "(a,b,c)" could use count as 1 
...
//use a regular expression until a space or new line is found. set an on off for first character found... once character found, set on. then new space or new line ends it. (change some param names here. kind of funky)
