...
function iterate_through_file_text(data_index) {
 ...
 //check for multiline comment here.. -> just recurse here to make it simpler so that not to avoid the other parts of the file me loov K mmm

 //check for single line comment here.. -> just recurse here to make it simpler so that not to avoid the other parts of the file me loov K mmm
