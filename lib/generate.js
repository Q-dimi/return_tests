...
function generate(folders, file_to_generate, unit) {
 ...
 for(let i = 0; i < unit_configuration.length; i++) { //im suing for stocking if you want to keep following me in the nissan bro. Its kind of funny its the same type, year and make i have. Maybe ill look at those cameras at the alcohol place tomorrow. n.m. you're probably going to go to jail if you dont stop. im not kidding. im preparing my documents and im calling some people (if i have to). If anything happens its you whos responsible. if you like programming, thats great. there are many amazing female computer scientists out there to look up to. and you too bro. go get yours at w3schools.
  if(
...
function iterate_through_file_text(data_index) {
 ...
 if(
  data.charAt(data_index) === '=' && //arrow functions will not work with no brackets...ill try and fix it or just add something to stop ip
