 ...
 */  
 ...
 /* 
  Enter into a regular function (will try and add every combination off this.. just fix the beginning and ending values) and start the build string. Above makes sure that the function below is built outside of a string, multiline comment and single line comment. So, I am getting the pure function when coming from the outside. When I do get a function, I ignore the outside, and focus on the inside. On the inside, I push every character, but dont run some conditions dependent on comments/strings. Once I hit this, im inside the function, and i simply just push every character and count brackets.
 */
