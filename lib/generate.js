 ...
 */
 ...
 /*
  opening and closing bracket tracked to determine when the function ends
 */
 ...
 */
 ...
 /* 
  end creating the function. (both brackets equal, or arrow function new line) ...also not in string, multi, single
 */
 ...
 */
 ...
 if(in_bt_string === false && data.charAt(bt_index) === ')') {
  ...
  opening_bt_parentheses = closing_bt_parentheses + 1;
 }

 /*
  adding to the arrow function parameter character. I add every character
 */

 bt_arrow_parameter_string.unshift(data.charAt(bt_index));
 
 /*
  return the parameters "wow = (a,b,c)"" or "wow = async (a,b,c)" count should always be 1 here for closing and opening
 */

 if(closing_bt_parentheses === opening_bt_parentheses) { 
