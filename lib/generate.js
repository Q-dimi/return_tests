...
//do the comments. look it over again, run a test. fix it. clean it. end it. then just watch my back because clearly there are some people who want it and i aint afraid to give it to em pop pop ya gone bich see ya and ya aint comin back... forever. black sky
 ...
 */
 ...
 /* 
  end creating the function. (both brackets equal, or arrow function new line) ... count on bracket length instead of array
 */
...
function file_end_reset_name_space() { 
  in_string_outside_of_function = [];
  in_string_outside_of_function_ = false;
  in_function = false;
