  ...
  /* 
   ...
   Title: generate
   Description: strips every type of function in node.js, client side javascript and react. Pass in a set of folders/files and all functions with contents will be pushed. Will eventually add functions from other programming languages. just attach a language condition to the set of conditions
   Author: Alexander Eatman 
   License: MIT

   generate searches selected folders/files and strips... 
   ...
   should only use regular functions, named regular functions, arrow functions no name (object), named arrow functions. This would be the base
   add file types and check for in script out of script <script 
   only take .html, .js and .ts for now. not going to do other languages
  ...
  */
  ...
  var debug = [];
  var function_types = {
    regular: true, //backtrack on this
    arrow: true, 
