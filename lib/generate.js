 ...
 */
 ...
 if(
  ...
  data_index = data_index + 1; 
  // console.log('im in a string or comment outside the function, recurse.')
  return iterate_through_file_text(data_index);
 }
 ...
 */
 ...
 /*
  ...
  reversed it to avoid triple quote error
 */
 ...
 */
 ...
 if(
  ...
  console.log('pushing the funciton finally ------------------------- not really though')
  push_function();
 } 
