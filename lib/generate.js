 ...
 */
 ...
 /*
  exit a multiline comment outside the function. (if in a multi-line comment, not in a single-line comment, and not in a string) <-- dont need last two conditions but helps clear some things
 */
 ...
 */
 ...
 /*
  exit a single line comment outside the function (if in a single-line comment, not in a multi-line comment, and not in a string) <-- dont need last two conditions but helps clear some things
 */
 ...
 /* 
  enter into a string outside the function (if not in a string, single-line comment, and multi-line comment)
 */
 ...
 /*
  exit a string outside the function (if in a string, not in a single-line comment, and not in a multi-line comment) <-- dont need last two conditions but helps clear some things
 */
