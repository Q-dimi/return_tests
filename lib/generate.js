 ...
 */
 ...
 /* 
  enter into a string inside the function (if not or in a string, single-line comment, and multi-line comment) whether im in or out of a string. dont need first two but helps make things clear.
 */
...
function get_arrow_parameter_function_name(bt_index_drop_off_function_name) { 
  ...
  */
  ...
  /*
    the function name has been appended because a space between the declaration type and function. Or the : if an object and no function name. not sure if /s and ' ' are the same thing 
  */
