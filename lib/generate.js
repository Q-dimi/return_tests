 ...
 */
 ...
 if(
  ...
  // console.log('entering a multiline comment');
 ...
 */
 ...
 if(
  ...
  in_comment_type_outside_function_multi = false;
  data_index = data_index + 2; 
  console.log('exiting a multiline comment');
  return iterate_through_file_text(data_index);
 }
 ...
 */
 ...
 if(
  ...
  data_index = data_index + 2;
  console.log('entering a single line comment');
  return iterate_through_file_text(data_index);
 }
 ...
 */
 ...
 if(
  ...
  console.log('exiting a single line comment');
  return iterate_through_file_text(data_index);
 }
 ...
 */
 ...
 if(
  ...
  //may just need to run the check here... rearrange this section
 ...
 */
 ...
 if(
  ...
  in_string_outside_of_function_ = false;
  console.log('exiting a string outside a function');
  return iterate_through_file_text(data_index);
 }
