  ...
  /* 
   ...
   It works. Create a file that contains aall tests to pass. https://www.youtube.com/watch?v=xdUpOao7ahw epic God music for who is reading
   
   make sure to add the correct file path and line number as well.
...
function get_arrow_parameter_function_name(bt_index_drop_off_function_name) { 
 ...
 /*
  if async exists add to the string... index remains the same for the next condition, which begins the function name, if not async
 */
