  ...
  /* 
   ...
   monday 1-9 tuesday 3-9 friday 2-9 saturday 2-9 make sure to check schedule. also bro in the black. you are being tracked. yeah you who came to the back. video footage backtracking on that too bro. keep driving by je. you are doing great. Seek outward before this turns into something.
 ...
 */  
 ...
 /* 
  Enter into a regular function (will try and add every combination off this.. just fix the beginning and ending values... actually just seperate invokable and whatever the fuck else there is) and start the build string. Above makes sure that the function below is built outside of a string, multiline comment and single line comment. So, I am getting the pure function when coming from the outside. When I do get a function, I ignore the outside, and focus on the inside. On the inside, I push every character, but dont run some conditions dependent on comments/strings. Once I hit this, im inside the function, and i simply just push every character and count brackets.
 */
 ...
 if(
  ...
  build_string = back_track_regular(drop_off_index_reg); //also make sure to back track the var a = function() change this to the array
...
/*
 Continue to recurse or check for valid functions in html script. Set to on or off -----------------------------------------------------
*/

function in_script_html() { 
