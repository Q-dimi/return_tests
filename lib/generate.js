  ...
  /* 
   ...
   take declaration type into consideration 
   use backtracking arrays on every function that is found
   create the conditions using functoins
  */
 ...
 */
 ...
 /*
  if not in a comment or string, keeping count of brackets to know when to end the function
 */
 ...
 /* 
  end creating the function.. the top condition should hit one time then going out of the function. The bottom should keep hitting. once pushed, reset everything and note that out of a function.
 */
...
/*
 REGULAR BT BEGINNING: ------------------------------------------------------ use backtracking array to turn things on and off so that I can build the beginning of the function.
*/
