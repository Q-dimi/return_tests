  ...
  /* 
   ...
   Title: generate
   Description: strips every type of function in node.js and javascript. Pass in a set of folders/files and all functions with contents will be pushed. Will eventually add functions from other programming languages. Currently node.js, react, and browser js 
