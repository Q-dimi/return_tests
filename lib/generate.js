var fs = require('file-system'); //whats a name space. this is environment dependent code and no one else is writing it so it is not necessary to use a namespace aidan. it just wastes time. you fucking fool
