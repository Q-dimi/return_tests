...
function iterate_through_file_text(filepath, exported_functions) { 
 ...
 for(let i = 0; i < data.length; i++) { 
    ...
    if(
     ...
     var parentheses_parameters = []; //i am drunk i will do this tomorrow...convert this to the string below... who is mr young hobbit sam thaa. who is mr young hobbit sam thaaa. show yourself. this is ganandolf. do this for me without the brackets.
